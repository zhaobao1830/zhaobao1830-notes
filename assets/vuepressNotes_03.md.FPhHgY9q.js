import{_ as s,o as n,c as a,R as p}from"./chunks/framework.1nBpG9uI.js";const e="/zhaobao1830-notes/assets/01.svcQGxJG.png",v=JSON.parse('{"title":"项目在github上自动部署，执行Install pnpm报错","description":"","frontmatter":{},"headers":[],"relativePath":"vuepressNotes/03.md","filePath":"vuepressNotes/03.md","lastUpdated":1772674867000}'),l={name:"vuepressNotes/03.md"},i=p('<h1 id="项目在github上自动部署-执行install-pnpm报错" tabindex="-1">项目在github上自动部署，执行Install pnpm报错 <a class="header-anchor" href="#项目在github上自动部署-执行install-pnpm报错" aria-label="Permalink to &quot;项目在github上自动部署，执行Install pnpm报错&quot;">​</a></h1><h2 id="问题" tabindex="-1">问题： <a class="header-anchor" href="#问题" aria-label="Permalink to &quot;问题：&quot;">​</a></h2><p>在使用github actions部署博客时，突然出现以下报错：</p><p><img src="'+e+`" alt="Image text"></p><h2 id="解决" tabindex="-1">解决： <a class="header-anchor" href="#解决" aria-label="Permalink to &quot;解决：&quot;">​</a></h2><p>1、查看docs.yml里pnpm和node的配置</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>      # 安装 pnpm</span></span>
