import{_ as s,o as n,c as a,R as e}from"./chunks/framework.3AywRrgj.js";const g=JSON.parse('{"title":"scroll-view使用enable-flex，竖直方向可能会增加布局空间的高度","description":"","frontmatter":{},"headers":[],"relativePath":"miniProgramNotes/03.md","filePath":"miniProgramNotes/03.md","lastUpdated":1704436473000}'),l={name:"miniProgramNotes/03.md"},p=e(`<h1 id="scroll-view使用enable-flex-竖直方向可能会增加布局空间的高度" tabindex="-1">scroll-view使用enable-flex，竖直方向可能会增加布局空间的高度 <a class="header-anchor" href="#scroll-view使用enable-flex-竖直方向可能会增加布局空间的高度" aria-label="Permalink to &quot;scroll-view使用enable-flex，竖直方向可能会增加布局空间的高度&quot;">​</a></h1><p>微信小程序和uniapp里的scroll-view组件，不要使用enable-flex，如果使用了，在竖直方向可能会增加布局空间的高度</p><p>有俩个解决办法：</p><p>一、在最外层设置高度。缺点是之后高度变了，还得再次修改</p><p>二、去掉enable-flex，在内部加一个view组件，在view组件上设置flex布局（推荐）</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;scroll-view scroll-x class=&quot;scroll-view&quot;&gt;</span></span>
