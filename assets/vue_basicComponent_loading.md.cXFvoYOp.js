import{_ as s,o as n,c as a,R as i}from"./chunks/framework.1nBpG9uI.js";const E=JSON.parse('{"title":"loading","description":"","frontmatter":{},"headers":[],"relativePath":"vue/basicComponent/loading.md","filePath":"vue/basicComponent/loading.md","lastUpdated":1705031681000}'),p={name:"vue/basicComponent/loading.md"},l=i(`<h1 id="loading" tabindex="-1">loading <a class="header-anchor" href="#loading" aria-label="Permalink to &quot;loading&quot;">​</a></h1><h2 id="loading组件" tabindex="-1">loading组件 <a class="header-anchor" href="#loading组件" aria-label="Permalink to &quot;loading组件&quot;">​</a></h2><p>加载数据时显示</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
