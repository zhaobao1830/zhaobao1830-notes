...
[转载地址](https://juejin.cn/post/7007031572238958629)

[参考地址](https://juejin.cn/post/6973637298755731463)
...
async函数是Generator函数的语法糖,那就说明用其他方式其实也可以实现他的效果，我们今天就是讲一讲怎么去实现async/await，用到的是ES6里的迭代函数——generator函数
