...
五、在vitePress中使用，会搜索不出数据

需要在[algolia的Editor](https://crawler.algolia.com/admin/crawlers/d153eacd-6b9f-433d-89d6-1ecda324df3e/configuration/edit)里添加相关配置
...
new Crawler({
  ...
  sitemaps: ["https://zhaobao1830.github.io/zhaobao1830-notes//sitemap.xml"],
