...
![Image text](../.vuepress/public/javaKnowledge/01/12.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/13.png)

**已经有了@Component，为什么还会出现@Configuration呢？**

为了解决变化，单独的@Component是没有意义的，无法解决变化

![Image text](../.vuepress/public/javaKnowledge/01/14.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/15.png)

**@Configuration是用来替换bean的xml配置**

![Image text](../.vuepress/public/javaKnowledge/01/16.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/17.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/18.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/19.png)

发现@SpringBootApplication是一个组合注解。

### @SpringBootConfiguration注解

![Image text](../.vuepress/public/javaKnowledge/01/20.png)

这个注解很简单，表明该类是一个Spring的配置类。

**@Configuration注解**

![Image text](../.vuepress/public/javaKnowledge/01/21.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/22.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/28.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/23.png)

**@Import注解**

一，@Import（配置类.class）

![Image text](../.vuepress/public/javaKnowledge/01/24.png)

二，设置一个ImportSelector接口的实现类，实现ImportSelects方法，返回配置类全类名；

![Image text](../.vuepress/public/javaKnowledge/01/25.png)

返回的是一个数组，可以一次导入多个bean的元类

![Image text](../.vuepress/public/javaKnowledge/01/26.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/27.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/29.png)
...
![Image text](../.vuepress/public/javaKnowledge/01/30.png)
